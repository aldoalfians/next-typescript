...
const PromoCard = () => {
  return (
    <article className='bg-white shadow-lg rounded-xl overflow-hidden w-[500px] h-[321px] flex'>
      <figure className='relative w-[212px] h-full'>
        <Image
          src='/assets/home/borobudur.jpg'
          alt='Borobudur'
          layout='fill'
          objectFit='cover'
      ...
      <div className='flex flex-col flex-1 justify-center p-4'>
        ...
        <div className='flex gap-1'>
          ...
          <p className='text-heading-5 text-red-100 font-bold'>10% OFF</p>
        </div>
        ...
        <p className='text-heading-5 text-gray-50 mb-4'>
          Berangkat: 28-November-2021 18:00
        </p>
